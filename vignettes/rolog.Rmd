...
vectors of length _N_, including the terms `#/0` and `#/1` that map to R vectors
of length 0 and 1, respectively. Translation of a polymorphic Prolog term such
as `#(a, 1.5)` to R will fail, since `rolog` expects the arguments to be
numeric.
